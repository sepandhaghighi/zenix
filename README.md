...
### Source Code
- Download [Version 0.5](https://github.com/sepandhaghighi/zenix/archive/v0.5.zip) or [Latest Source](https://github.com/sepandhaghighi/zenix/archive/dev.zip)
- `pip install .`				

### PyPI

- Check [Python Packaging User Guide](https://packaging.python.org/installing/)     
- `pip install zenix==0.5`						
